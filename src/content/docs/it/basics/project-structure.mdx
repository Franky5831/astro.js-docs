...
Questo comportamento rende `public/` ideale per risorse comuni che non richiedono alcuna elaborazione, come immagini e font, o file speciali come `robots.txt` e `manifest.webmanifest`.
...
Consulta la [guida alla configurazione di Astro](/it/reference/configuration-reference/) per i dettagli sull'impostazione delle configurazioni.
