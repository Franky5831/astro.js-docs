...
**Astro è stato progettato per la creazione di siti web ricchi di contenuti.** Ciò include siti di marketing, siti di pubblicazione, siti di documentazione, blog, portfolio, landing page, siti di community e siti di e-commerce. Se hai contenuti da mostrare, devono raggiungere il tuo lettore rapidamente.

Al contrario, la maggior parte dei moderni web framework sono progettati per la creazione di *applicazioni web*. Questi framework eccellono nella creazione di esperienze più complesse simili a quelle delle applicazioni nel browser: dashboard di amministrazione con accesso, caselle di posta, social networks, liste di attività e persino applicazioni simili a quelle native come [Figma](https://figma.com/) e [Ping](https://ping.gg/). Tuttavia, con quella complessità, possono faticare a fornire ottime prestazioni quando si tratta di distribuire i tuoi contenuti.
...
La magia di Astro sta nel modo in cui combina i due valori spiegati sopra: un'attenzione al contenuto con un'architettura MPA orientata al server, unendo questi due approcci in maniera ottimale e offrire funzionalità che altri framework non possono offrire. Il risultato sono prestazioni web straordinarie per ogni sito web, direttamente dalla confezione. Il nostro obiettivo: **Dovrebbe essere quasi impossibile creare un sito web lento con Astro.**
